...
(async function fetchData(dataArray = []) {
    ...
    const urlArray = [
      'https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=02b1b4b084630e56daa71584d11844f9',
      'https://api.openweathermap.org/data/2.5/weather?q=Houston&APPID=02b1b4b084630e56daa71584d11844f9',
      'https://api.openweathermap.org/data/2.5/weather?q=Lisbon&APPID=02b1b4b084630e56daa71584d11844f9',
      'https://api.openweathermap.org/data/2.5/weather?q=Baltimore&APPID=02b1b4b084630e56daa71584d11844f9',
    ];
      ...
      makeRequest(url).then(function (result) {
        ...
        if (dataArray.length == urlArray.length) {
          // STEP 2: Loop through each item in the `dataArray` and use the logic below by uncommenting the code to see if it is the correct weather data for `Lisbon`
           ...
           if (JSON.parse(data).name == "Lisbon"){
          ...
          // // You will need to change the itemInDataArray variable to match your own variable that stores the current item in array that you are checking
              ...
              addLisbonDataToDocument(data, dataArray);
          }
  ...
  //02b1b4b084630e56daa71584d11844f9
